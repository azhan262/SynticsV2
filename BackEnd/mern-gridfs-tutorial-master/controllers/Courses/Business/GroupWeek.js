...
var { SectionsBusinessGroupWeek } = require('../../../models/Courses/Business/GroupWeek')
 ...
 router.post('/business-group-week-create-sections', (req, res) => {
    Student.find({"courses" : "Business / Group / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsBusinessGroupWeek({
...
router.post('/business-group-week-deletefields', (req, res) => {
