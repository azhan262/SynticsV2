...
var { SectionsBusinessOneMonth } = require('../../../models/Courses/Business/OneMonth')
 ...
 router.post('/business-one-month-create-sections', (req, res) => {
    Student.find({"courses" : "Business / One-One / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsBusinessOneMonth({
...
router.post('/business-one-month-deletefields', (req, res) => {
