...
var { SectionsBusinessOneWeek } = require('../../../models/Courses/Business/OneWeek')
 ...
 router.post('/business-one-week-create-sections', (req, res) => {
    Student.find({"courses" : "Business / One-One / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsBusinessOneWeek({
...
router.post('/business-one-week-deletefields', (req, res) => {
