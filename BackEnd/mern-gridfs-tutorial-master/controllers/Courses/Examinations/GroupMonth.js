...
var { SectionsExaminationsGroupMonth } = require('../../../models/Courses/Examinations/GroupMonth')
 ...
 router.post('/examination-group-month-create-sections', (req, res) => {
    Student.find({"courses" : "Examination / Group / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsExaminationsGroupMonth({
...
router.post('/examination-group-month-deletefields', (req, res) => {
