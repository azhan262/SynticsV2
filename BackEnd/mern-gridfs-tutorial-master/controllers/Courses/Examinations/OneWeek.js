...
var { SectionsExaminationsOneWeek } = require('../../../models/Courses/Examinations/OneWeek')
 ...
 router.post('/examination-one-week-create-sections', (req, res) => {
    Student.find({"courses" : "Examination / One-One / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsExaminationsOneWeek({
...
router.post('/examination-one-week-deletefields', (req, res) => {
