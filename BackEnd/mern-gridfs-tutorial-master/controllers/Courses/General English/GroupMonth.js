...
var { SectionsGeneralGroupMonth} = require('../../../models/Courses/General English/GroupMonth')
 ...
 router.post('/general-group-month-create-sections', (req, res) => {
    Student.find({"courses" : "General / Group / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsGeneralGroupMonth({
...
router.post('/general-group-month-deletefields', (req, res) => {
