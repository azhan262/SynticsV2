...
var { SectionsGeneralGroupWeek} = require('../../../models/Courses/General English/GroupWeek')
 ...
 router.post('/general-group-week-create-sections', (req, res) => {
    Student.find({"courses" : "General / Group / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsGeneralGroupWeek({
...
router.post('/general-group-week-deletefields', (req, res) => {
