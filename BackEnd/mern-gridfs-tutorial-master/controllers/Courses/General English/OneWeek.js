...
var { SectionsGeneralOneWeek} = require('../../../models/Courses/General English/OneWeek')
 ...
 router.post('/general-one-week-create-sections', (req, res) => {
    Student.find({"courses" : "General / One-One / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsGeneralOneWeek({
...
router.post('/general-one-week-deletefields', (req, res) => {
