...
var { SectionsIELTS10GroupMonth } = require('../../../models/Courses/IELTS/TwentyTwo10Month')
 ...
 router.post('/IELTS-tengroup-month-create-sections', (req, res) => {
    Student.find({"courses" : "IELTS / 22-10 / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsIELTS10GroupMonth({
...
router.post('/IELTS-tengroup-month-deletefields', (req, res) => {
