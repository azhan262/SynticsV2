...
var { SectionsJuniorGroupMonth} = require('../../../models/Courses/Junior/JuniorGroupMonth')
 ...
 router.post('/junior-group-month-create-sections', (req, res) => {
    Student.find({"courses" : "Junior / Group / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsJuniorGroupMonth({
...
router.post('/junior-group-month-deletefields', (req, res) => {
