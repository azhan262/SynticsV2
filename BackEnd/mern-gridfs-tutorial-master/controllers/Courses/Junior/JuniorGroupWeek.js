...
var { SectionsJuniorGroupWeek} = require('../../../models/Courses/Junior/JuniorGroupWeek')
 ...
 router.post('/junior-group-week-create-sections', (req, res) => {
    Student.find({"courses" : "Junior / Group / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsJuniorGroupWeek({
...
router.post('/junior-group-week-deletefields', (req, res) => {
