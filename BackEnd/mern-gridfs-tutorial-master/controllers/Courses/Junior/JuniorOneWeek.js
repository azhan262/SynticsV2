...
var { SectionsJuniorOneWeek} = require('../../../models/Courses/Junior/JuniorOneWeek')
 ...
 router.post('/junior-one-Week-create-sections', (req, res) => {
    Student.find({"courses" : "Junior / One-One / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsJuniorOneWeek({
...
router.post('/junior-one-Week-deletefields', (req, res) => {
