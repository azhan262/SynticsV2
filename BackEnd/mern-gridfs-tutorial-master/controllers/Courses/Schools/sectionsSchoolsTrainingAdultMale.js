...
var { SectionsSchoolsTrainingAdultMale } = require('../../../models/Courses/Schools/sectionsSchoolsTrainingAdultMale')
...
router.post('/male-schools-adult-create-sections', (req, res) => {
    Student.find({ "gender" : "Male", "courses" : "School Adult" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsSchoolsTrainingAdultMale({
...
router.post('/male-schools-adult-deletefields', (req, res) => {
