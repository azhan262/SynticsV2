...
var { SectionsSpecialExaminationsGroupMonth} = require('../../../models/Courses/Specialized Examinations/GroupMonth')
 ...
 router.post('/specialExamination-group-month-create-sections', (req, res) => {
    Student.find({"courses" : "Specialised / Group / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsSpecialExaminationsGroupMonth({
...
router.post('/specialExamination-group-month-deletefields', (req, res) => {
