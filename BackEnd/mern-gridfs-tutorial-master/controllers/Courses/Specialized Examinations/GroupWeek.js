...
var { SectionsSpecialExaminationsGroupWeek} = require('../../../models/Courses/Specialized Examinations/GroupWeek')
 ...
 router.post('/specialExamination-group-week-create-sections', (req, res) => {
    Student.find({"courses" : "Specialised / Group / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsSpecialExaminationsGroupWeek({
...
router.post('/specialExamination-group-week-deletefields', (req, res) => {
