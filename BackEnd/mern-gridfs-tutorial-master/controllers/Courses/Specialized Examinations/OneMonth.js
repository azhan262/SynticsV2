...
var { SectionsSpecialExaminationsOneMonth} = require('../../../models/Courses/Specialized Examinations/OneMonth')
 ...
 router.post('/specialExamination-one-month-create-sections', (req, res) => {
    Student.find({"courses" : "Specialised / One-One / Month" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsSpecialExaminationsOneMonth({
...
router.post('/specialExamination-one-month-deletefields', (req, res) => {
