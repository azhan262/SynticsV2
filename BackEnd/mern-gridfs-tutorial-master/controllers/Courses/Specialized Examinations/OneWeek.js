...
var { SectionsSpecialExaminationsOneWeek} = require('../../../models/Courses/Specialized Examinations/OneWeek')
 ...
 router.post('/specialExamination-one-week-create-sections', (req, res) => {
    Student.find({"courses" : "Specialised / One-One / Week" },(err, doc) => {
        if (!err) {
            var count = 0
            ...
            doc.forEach(element => {
             ...
             sectionArray.forEach(element => {
                ...
                var emp = new SectionsSpecialExaminationsOneWeek({
...
router.post('/specialExamination-one-week-deletefields', (req, res) => {
