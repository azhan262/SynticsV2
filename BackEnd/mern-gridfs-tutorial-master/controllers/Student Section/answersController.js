 ...
 */
 ...
 router.post('/email', (req, res) => {
  Answers.find({ email: req.body.email },(err, doc) => {
    console.log("api hit")
...
router.post('/Grade-1', (req, res) => {
  Answers.find({ "grade" : "Grade 1"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-2', (req, res) => {
  Answers.find({ "grade" : "Grade 2"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-3', (req, res) => {
  Answers.find({ "grade" : "Grade 3"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-4', (req, res) => {
  Answers.find({ "grade" : "Grade 4"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-5', (req, res) => {
  Answers.find({ "grade" : "Grade 5"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-6', (req, res) => {
  Answers.find({ "grade" : "Grade 6"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-7', (req, res) => {
  Answers.find({ "grade" : "Grade 7"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-8', (req, res) => {
  Answers.find({ "grade" : "Grade 8"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-9', (req, res) => {
  Answers.find({ "grade" : "Grade 9"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-10', (req, res) => {
  Answers.find({ "grade" : "Grade 10"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-11', (req, res) => {
  Answers.find({ "grade" : "Grade 11"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
...
router.post('/Grade-12', (req, res) => {
  Answers.find({ "grade" : "Grade 12"},(err, doc) => {
       if (!err) { res.send(doc); }
       else { console.log('Error in Retrieving Answerss :' + JSON.stringify(err, undifines, 2)); }
   });
 ...
 router.post('/specific/:id', (req, res) => {
  ...
  console.log(id)
  Answers.find({ "studentId" : id} , (err, student) => {
    res.json(student);
  });
}); 
...
router.post("/specific/question/:questionId", (req, res) => {
  ...
  Answers.find({ "questionId" : questionId} , (err, student) => {
    res.json(student);
  });
}); 
