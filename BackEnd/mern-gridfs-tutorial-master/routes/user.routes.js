...
var upload = multer({
    ...
    fileFilter: (req, file, cb) => {
        ...
        || file.mimetype ==  "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" || file.mimetype == "application/vnd.ms-excel" || file.mimetype == "application/octet-stream"
        ...
        || file.mimetype == "application/force-download" || file.mimetype == "application/x-download" || file.mimetype == "binary/octet-stream" ) {
            cb(null, true);
        } else {
            cb(null, false);
