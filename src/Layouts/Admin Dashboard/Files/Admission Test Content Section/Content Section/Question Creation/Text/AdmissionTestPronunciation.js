...
function AdmissionTestPronunciationForAdmin() {
      ...
      <Row>
        <Col md="12">
          <Card className="card-plain">
            <CardHeader>Admission Test Pronunciation Content Creation Panel</CardHeader>
            <CardBody>
            <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className = "mt-4"> 
                      <div class="p-3 mb-2 bg-dark text-white">
                          <label ><h6 className="m-0 font-weight-bold text-white">Please create your desired <b>Pronunciation</b> Question below</h6></label>
                      </div>
                      <div class="p-3 mb-2 bg-light text-dark">
                        <Editor
...
export default AdmissionTestPronunciationForAdmin
