...
function SubjectsForTest() {
    ...
    const handleOnClick = (e) => {
        history.push({
            pathname:`/student/answer-list-test/${id}`,
  ...
  {/* Page Heading */}
  <h1 className="h3BlackDashboard mb-2 text-gray-800">List of Subjects For Test</h1>
...
export default SubjectsForTest
