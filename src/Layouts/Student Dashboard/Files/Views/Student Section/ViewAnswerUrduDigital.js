...
function ViewAnswerUrduDigital() {
    ...
    return (
      ...
      <div id="content">
        ...
        <div className="containerBlackDashboard-fluid">
          ...
          <div className="card shadow mb-4 text-center">
            <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
              <h6 className="m-0 font-weight-bold text-white">Teacher's Review</h6>
            </div>
            <div className="card-body">
                        <div className = "mt-4"> 
                            <div class="p-3 mb-2" style = {{color : "white", backgroundColor : "#a98799"}}>
                                <label><h6 className = "text-white">Obtained Marks</h6></label>
                            </div>
                            <hr />
                        ...
                        <div className = "mt-4"> 
                            <div class="p-3 mb-2" style = {{color : "white", backgroundColor : "#a98799"}}>
                                <label><h6 className = "text-white">Teacher's Remarks</h6></label>
                            </div>
                            <hr />
...
export default ViewAnswerUrduDigital
