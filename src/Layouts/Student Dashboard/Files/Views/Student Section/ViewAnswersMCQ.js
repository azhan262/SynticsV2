...
import { getAnswersMCQ } from '../../Apis/apiForAnswers'

function ViewAnswersMCQForStudent() {
    ...
    useEffect(() => {
      const fetchItems = async function() {
        const contents = await getAnswersMCQ()
...
export default ViewAnswersMCQForStudent
