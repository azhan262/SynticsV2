  ...
  stop = () => {
    Mp3Recorder
      ...
      .then(([buffer, blob]) => {
        ...
        console.log(blob)
        var findString = this.state.referenceName.indexOf(".")
        var newReferenceName = this.state.referenceName.slice(0,findString)
        var newFileName = newReferenceName + "update" + ".mp3"
