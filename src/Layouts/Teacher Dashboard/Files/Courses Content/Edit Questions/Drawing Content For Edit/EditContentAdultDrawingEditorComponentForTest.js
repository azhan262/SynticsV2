...
function EditContentAdultDrawingEditorComponentForTest() {
  let {id} = useParams()
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Drawing Test Creation Panel</h6>
      </div>
...
export default EditContentAdultDrawingEditorComponentForTest
