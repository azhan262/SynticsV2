...
import ModalWorkingForAudioRecord from "../Edit Questions/Audio Recording For Contact Us For Edit/ModalWorkingForAudioRecord"
import axios from 'axios';

function EditContentAudioForTeacherForTest() {
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Q/A Test Edit Panel</h6>
      </div>
...
export default EditContentAudioForTeacherForTest
