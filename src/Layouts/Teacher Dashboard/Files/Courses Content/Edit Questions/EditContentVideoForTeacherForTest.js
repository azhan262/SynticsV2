...
function EditContentVideoForTeacherForTest() {
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Video Test Edit Panel</h6>
      </div>
      ...
      <div>
        ...
        <video id = "audioReference" controls width="400"   type="video/webm" />
        </div>
        <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
...
export default EditContentVideoForTeacherForTest
