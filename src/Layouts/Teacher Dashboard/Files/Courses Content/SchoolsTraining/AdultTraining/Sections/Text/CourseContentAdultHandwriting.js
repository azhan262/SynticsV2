...
function CourseContentAdultHandwritingForTeacher() {
  let {id} = useParams()
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Handwriting Content Creation Panel</h6>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className = "mt-4"> 
                      <div class="p-3 mb-2 " style = {{color : "white", backgroundColor : "#a98799"}}>
                          <label><h6 className = "text-white">Please create your desired <b>Handwriting</b> Question below</h6></label>
                      </div>
                      <div class="p-3 mb-2 bg-light text-dark">
                        <Editor
...
export default CourseContentAdultHandwritingForTeacher
