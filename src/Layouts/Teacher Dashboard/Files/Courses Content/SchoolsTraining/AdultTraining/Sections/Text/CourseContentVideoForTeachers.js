...
function CourseContentVideoForTeachers() {
...
const log = (data) => {
    if (editorRef.current) {
      ...
      location.state.referenceName = location.state.referenceName + ".webm"
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Video Content Creation Panel</h6>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
                  <div className = "mt-4"> 
                      <div className="p-3 mb-2" style = {{color : "white", backgroundColor : "#a98799"}}>
                          <label><h6 className = "text-white">Question's Title ass</h6></label>
                      </div>
...
export default CourseContentVideoForTeachers
