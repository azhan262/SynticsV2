...
function CourseContentFileUploadForTest() {
    let {id} = useParams()
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Course Test Content Creation Panel</h6>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className="card-body">
                <div class="p-3 mb-2" style = {{color : "white", backgroundColor : "#a98799"}}>
                    <label><h6 className = "text-white">Upload File</h6></label>
                </div>
...
export default CourseContentFileUploadForTest
