...
function CourseContentDrawingEditorComponentForTest() {
  let {id} = useParams()
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white"> Drawing Test Creation Panel</h6>
      </div>
      <div className="card-body">
      <div class="p-3 mb-2" style = {{color : "white", backgroundColor : "#a98799"}}>
          <label><h6 className = "text-white">Upload Image for Test</h6></label>
     </div>
...
export default CourseContentDrawingEditorComponentForTest
