...
import { updateAnserReviewAssignment } from '../../../Apis/apiForAnswers';
import axios from 'axios';

function ViewCurrentAnswerContentAssignmentForTeacher() {
    let {id} = useParams()
...
export default ViewCurrentAnswerContentAssignmentForTeacher
