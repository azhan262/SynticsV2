...
function ViewCurrentAnswerForTeacherForTest() {
    let {id} = useParams()
...
<div className="containerBlackDashboard-fluid">
  ...
  <div className="card shadow mb-4 text-center">
    <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
      <h6 className="m-0 font-weight-bold text-white"> {location.state.name}'s Test Question </h6>
    </div>
  ...
  <div className="card shadow mb-4 text-center">
    <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
      <h6 className="m-0 font-weight-bold text-white"> {location.state.name}'s Test Review</h6>
    </div>
    <div className="card-body">
    <div>
    <div className = "mt-4">
...
export default ViewCurrentAnswerForTeacherForTest
