    ...
    if(location.state.answertype == "Drawing"){
        ...
        return(
            <div className = "mt-4">
                    ...
                    <div class="p-3 mb-2 bg-light text-dark">
                        <a id = "vidReference" controls style={{textDecoration : 'none', fontWeight: 'bold'}} >{location.state.questionReferenceName}</a>
                    </div>
                    <hr />
                </div>
        )
...
const handlingAnswerAttachments = () => {
    ...
    <div class="p-3 mb-2 bg-light text-dark">
        <a id = "imgAnswerReference"  className = "text-dark" style={{textDecoration : "none", fontWeight: "bold",}} >
