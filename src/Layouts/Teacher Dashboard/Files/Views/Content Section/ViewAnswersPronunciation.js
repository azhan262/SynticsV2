...
import { getAnswersPronunciation } from '../../Apis/apiForAnswers';

function ViewAnswersPronunciationForTeacher() {
    ...
    useEffect(() => {
      const fetchItems = async function() {
        const contents = await getAnswersPronunciation()
    ...
    const handleOnClick = (data) => {
      console.log(data)
          history.push({
            pathname:"/teacher/view-current-answer",
            state: data
          })
    }
    return (
...
export default ViewAnswersPronunciationForTeacher
