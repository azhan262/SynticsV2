...
import { getCoursePlanningsForGrade1 } from '../../../../Apis/apiForCoursePlanning';

function Grade1ContentForResultsForSubjectsForTeacher() {
                    ...
                    <div>
                        ...
                        <tbody>
                            ...
                            items.map(contents => (
                                ...
                                <td>
                                    <button className="btn btn-success" onClick={() => handleOnClickAnswers(contents)}>View Answers of Students</button>
                                </td>
                                </tr>
                            ))
                            }
...
export default Grade1ContentForResultsForSubjectsForTeacher
