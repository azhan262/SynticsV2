...
import { getCoursePlanningsForGrade10 } from '../../../../Apis/apiForCoursePlanning';


function Grade10ContentForResultsForSubjectsForTeacher() {
  const [items, setItems] = useState([])
  const [answers, setAnswers] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getCoursePlanningsForGrade10()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade10ContentForResultsForSubjectsForTeacher
