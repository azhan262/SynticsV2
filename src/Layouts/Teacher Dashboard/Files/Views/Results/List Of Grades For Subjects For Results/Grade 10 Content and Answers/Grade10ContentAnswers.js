...
import { getAnswersGrade10 } from '../../../../Apis/apiForAnswers';


function Grade10ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade10()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade10ContentAnswersForTeacher
