...
import { getAnswersGrade11 } from '../../../../Apis/apiForAnswers';


function Grade11ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade11()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade11ContentAnswersForTeacher
