...
import { getAnswersGrade12 } from '../../../../Apis/apiForAnswers';


function Grade12ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade12()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade12ContentAnswersForTeacher
