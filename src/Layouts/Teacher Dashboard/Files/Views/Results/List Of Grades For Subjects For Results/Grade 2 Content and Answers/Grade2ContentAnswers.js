...
import { getAnswersGrade2 } from '../../../../Apis/apiForAnswers';


function Grade2ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade2()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade2ContentAnswersForTeacher
