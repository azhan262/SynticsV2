...
import { getCoursePlanningsForGrade3 } from '../../../../Apis/apiForCoursePlanning';

function Grade3ContentForResultsForSubjectsForTeacher() {
  const [items, setItems] = useState([])
  const [answers, setAnswers] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getCoursePlanningsForGrade3()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade3ContentForResultsForSubjectsForTeacher
