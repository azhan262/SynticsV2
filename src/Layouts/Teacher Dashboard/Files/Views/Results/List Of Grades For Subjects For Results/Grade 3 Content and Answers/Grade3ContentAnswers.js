...
import { getAnswersGrade3 } from '../../../../Apis/apiForAnswers';


function Grade3ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade3()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade3ContentAnswersForTeacher
