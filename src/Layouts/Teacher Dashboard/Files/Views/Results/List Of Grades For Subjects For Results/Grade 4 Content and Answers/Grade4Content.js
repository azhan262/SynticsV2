...
import { getCoursePlanningsForGrade4 } from '../../../../Apis/apiForCoursePlanning';


function Grade4ContentForResultsForSubjectsForTeacher() {
  const [items, setItems] = useState([])
  const [answers, setAnswers] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getCoursePlanningsForGrade4()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade4ContentForResultsForSubjectsForTeacher
