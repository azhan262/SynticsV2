...
import { getCoursePlanningsForGrade5 } from '../../../../Apis/apiForCoursePlanning';


function Grade5ContentForResultsForSubjectsForTeacher() {
  const [items, setItems] = useState([])
  const [answers, setAnswers] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getCoursePlanningsForGrade5()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade5ContentForResultsForSubjectsForTeacher
