...
import { getAnswersGrade5 } from '../../../../Apis/apiForAnswers';


function Grade5ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade5()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade5ContentAnswersForTeacher
