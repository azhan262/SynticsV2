...
import { getAnswersGrade6 } from '../../../../Apis/apiForAnswers';


function Grade6ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade6()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade6ContentAnswersForTeacher
