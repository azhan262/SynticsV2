...
import { getCoursePlanningsForGrade7 } from '../../../../Apis/apiForCoursePlanning';


function Grade7ContentForResultsForSubjectsForTeacher() {
  const [items, setItems] = useState([])
  const [answers, setAnswers] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getCoursePlanningsForGrade7()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade7ContentForResultsForSubjectsForTeacher
