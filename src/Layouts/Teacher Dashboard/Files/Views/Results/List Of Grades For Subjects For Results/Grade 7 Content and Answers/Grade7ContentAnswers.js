...
import { getAnswersGrade7 } from '../../../../Apis/apiForAnswers';


function Grade7ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade7()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade7ContentAnswersForTeacher
