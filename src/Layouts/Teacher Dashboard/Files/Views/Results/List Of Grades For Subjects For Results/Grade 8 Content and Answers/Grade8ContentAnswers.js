...
import { getAnswersGrade8 } from '../../../../Apis/apiForAnswers';


function Grade8ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade8()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade8ContentAnswersForTeacher
