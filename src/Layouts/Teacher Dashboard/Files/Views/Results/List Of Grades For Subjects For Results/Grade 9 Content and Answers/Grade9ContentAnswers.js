...
import { getAnswersGrade9 } from '../../../../Apis/apiForAnswers';



function Grade9ContentAnswersForTeacher() {
    const history = useHistory()
    const [items, setItems] = useState([])
    useEffect(() => {
        const fetchItems = async function() {
          const contents = await getAnswersGrade9()
          setItems(contents)
        }
        fetchItems()
      }, []);
...
export default Grade9ContentAnswersForTeacher
