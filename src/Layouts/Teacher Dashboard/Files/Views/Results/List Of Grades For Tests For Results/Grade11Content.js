...
function Grade11ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade11()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade11ContentTestForResultsForTestForTeacher
