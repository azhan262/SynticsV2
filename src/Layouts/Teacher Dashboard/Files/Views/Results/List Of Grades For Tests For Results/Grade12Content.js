...
import { getTestPlanningsForGrade12 } from '../../../Apis/apiForTestContentPlanning';

function Grade12ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade12()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade12ContentTestForResultsForTestForTeacher
