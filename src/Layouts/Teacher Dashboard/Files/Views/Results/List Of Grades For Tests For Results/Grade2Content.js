...
import { getTestPlanningsForGrade2 } from '../../../Apis/apiForTestContentPlanning';

function Grade2ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade2()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade2ContentTestForResultsForTestForTeacher
