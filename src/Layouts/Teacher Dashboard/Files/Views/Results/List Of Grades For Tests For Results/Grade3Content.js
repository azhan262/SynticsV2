...
import { getTestPlanningsForGrade3 } from '../../../Apis/apiForTestContentPlanning';

function Grade3ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade3()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade3ContentTestForResultsForTestForTeacher
