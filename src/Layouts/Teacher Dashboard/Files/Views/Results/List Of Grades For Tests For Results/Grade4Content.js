...
import { getTestPlanningsForGrade4 } from '../../../Apis/apiForTestContentPlanning';

function Grade4ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade4()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade4ContentTestForResultsForTestForTeacher
