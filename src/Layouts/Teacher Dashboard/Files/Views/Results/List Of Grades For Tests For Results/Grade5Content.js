...
function Grade5ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade5()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade5ContentTestForResultsForTestForTeacher
