...
function Grade6ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade6()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade6ContentTestForResultsForTestForTeacher
