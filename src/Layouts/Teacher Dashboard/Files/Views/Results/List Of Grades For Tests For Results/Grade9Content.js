...
import { getTestPlanningsForGrade9 } from '../../../Apis/apiForTestContentPlanning';

function Grade9ContentTestForResultsForTestForTeacher() {
  const [items, setItems] = useState([])

  useEffect(() => {
    const fetchItems = async function() {
      const contents = await getTestPlanningsForGrade9()
      setItems(contents)
    }
    fetchItems()
  }, []);
...
export default Grade9ContentTestForResultsForTestForTeacher
