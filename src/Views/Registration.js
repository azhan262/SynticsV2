...
function Registration() {
  ...
  const [newNameForCv, setNewNameForCv] = useState([])
    ...
    const onSubmit = async (data) => {
      ...
      //redirecting 
      history.push("/main/login-auth-student")
    };
      ...
      const formik = useFormik({
          ...
          validate: values => {
              ...
              if(!values.guardian){
                errors.guardian = "Please fill in Father/Guardian Name"
              }else if (!letters.test(values.guardian)) {
                  errors.guardian = "Please enter a valid Name"
              }
              if(!values.password){
                  errors.password = "Please fill in your Password"
              }
              if(!values.cnic){
                errors.cnic = "Please fill in your B-FORM/CNIC"
            }
            ...
            <div className="title_container">
              ...
              <div className="row clearfix">
                      <div className="col-md-6 mt-3 mt-3">
                        ...
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Full Name</label>
                      ...
                      <div className="col-md-6 mt-3 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Father/Guardian Name*</label>
                        <div className="input_field"> <span><i aria-hidden="true" className="fa fa-user" /></span>
                        <input type="text" name="guardian" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.guardian}  required />
                        </div>
                        {formik.errors.guardian && formik.touched.guardian  ? (<div className='error' style ={{color:'red'}}>{formik.errors.guardian}</div>) : null}
                      
                      </div>
                      <div className="col-md-6 mt-3 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Password*</label>
                        <div className="input_field"> <span><i aria-hidden="true" className="fa fa-key" /></span>
                        <input type="password" name="password" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.password}  required />
                        </div>
                        {formik.errors.password && formik.touched.password ? (<div className='error' style ={{color:'red'}}>{formik.errors.password}</div>) : null}
                      
                      </div>
                      <div className="col-md-6 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Confirm Password*</label>
                        <div className="input_field"> <span><i aria-hidden="true" className="fa fa-key" /></span>
                      ...
                      <div className="col-md-6 mt-3" id>
                        <div className="form-group">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Email Address*</label>
                      ...
                      <div className="col-md-6 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Date of Birth*</label>
                      ...
                      <div className="col-md-6 mt-3 school-div">
                      <div className="form-group">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Grade:</label>
                        <div className="input_field select_option">
                        <select name="classesGrade"  onChange={formik.handleChange}  onBlur={formik.handleBlur} value={formik.values.classesGrade}>
                        <option value = "selectAGrade">Select Grade</option>
                        ...
                        {formik.touched.className ? (<div className='error' style ={{color:'red'}}>{formik.errors.class_name}</div>) : null}
                      </div>
                      </div>
                      <div className="col-md-6 mt-3" >
                                    <div className="form-group">
                                        <label className = "text-dark" style={{fontWeight:"bold"}}>Country Code</label>
                                        <div className="input_field select_option">
                                            <select name="country_code" onChange={formik.handleChange} onBlur={formik.handleBlur}  value={formik.values.country_code}  required>
                                                            <option value = "chooseCountryCode">Country Code</option>
                                            ...
                                            {formik.touched.country_code ? (<div className='error' style ={{color:'red'}}>{formik.errors.country_code}</div>) : null}
                                    </div></div>
                            <div className="col-md-6 mt-3">
                            <div className="form-group">
                            ...
                            <div className="input_field"> <span><i aria-hidden="true" className="fa fa-phone" /></span>
                                <input type="text" name="phone" placeholder="Enter your Contact" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.contact} required />
                                </div>
                        ...
                        <div className="form-group">
                          <label className = "text-dark" style={{fontWeight:"bold"}}>Country</label>
                          <div className="input_field select_option">
                          ...
                          {formik.touched.country ? (<div className='error' style ={{color:'red'}}>{formik.errors.country}</div>) : null}
                        </div>
                      </div>
                      <div className="col-md-6 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Province*</label>
                        <div className="input_field select_option">
                        <select name="province" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.province} >
                      ...
                      <div className="col-md-6 mt-3">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>B-Form/NIC Number*</label>
                        <div className="input_field"> <span><i aria-hidden="true" className="fa fa-id-card" /></span>
                        <input type="text" name="cnic" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.cnic}  />
                        </div>
                        {formik.errors.cnic && formik.touched.cnic ? (<div className='error' style ={{color:'red'}}>{formik.errors.cnic}</div>) : null}
                      </div>
                      <div className="col-md-6 mt-3">
                        <div className="">
                          <label className="form-label text-dark" style = {{fontWeight:'bold'}} htmlFor>Upload B-Form/CNIC</label>
                          <div>
                          <input id="formFile"   type="file" required onChange={(e) => fileChanged(e)} />
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6 mt-3">
                        <div className="form-group">
                        <label className = "text-dark" style={{fontWeight:"bold"}}>Address</label>
                        <div className="input_field">
                            <textarea className = "w-100" name="address" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.address}   >
                            </textarea>
                            </div>
                        </div>
                      </div>
